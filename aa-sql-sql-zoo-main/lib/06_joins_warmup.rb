...
def casablanca_cast
  ...
  FROM actors
    JOIN castings 
      on actor_id = actors.id and movie_id = (select id from movies where title = 'Casablanca') order by name
  SQL
end
...
def alien_cast
  ...
  FROM actors
    JOIN castings 
      on actor_id = actors.id and movie_id = (select id from movies where title = 'Alien') order by name
  SQL
end
